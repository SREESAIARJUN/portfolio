        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="portfolio-card animate-fade-in-up">
            ...
            <p className="text-muted-foreground mb-4">
              I'm an aspiring AI/ML Engineer with hands-on experience in LLMs, NLP, and anomaly detection. Currently in my Pre-final year of B.Tech in AI/ML at Mohan Babu University with a CGPA of 9.82.
            </p>
            <p className="text-muted-foreground">
              I'm also pursuing a Minor in AI from IIT Ropar, which allowed me to gain deeper insights into advanced AI concepts and research methodologies.
            </p>
          </div>
